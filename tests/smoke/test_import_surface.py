...
IMPORTABLE_MODULES: tuple[str, ...] = (
    ...
    "globin.domain.identifiers",
    "globin.domain.observability",
    "globin.domain.precision",
    ...
    "globin.application.configuration",
    "globin.application.observability",
    "globin.adapters",
    "globin.adapters.architecture",
    "globin.adapters.clock",
    "globin.adapters.configuration",
    "globin.adapters.identifiers",
