...
from globin.domain.configuration import (
    ...
    CLOCK_DEGRADED_GRACE_MILLIS,
    CLOCK_FRESHNESS_TTL_MILLIS,
    CLOCK_MAX_OFFSET_JUMP_MILLIS,
    CLOCK_MAX_ROUND_TRIP_MILLIS,
    CLOCK_MAX_UNCERTAINTY_MILLIS,
    CLOCK_MAX_WALL_DIVERGENCE_MILLIS,
    CLOCK_NETWORK_BUDGET_MILLIS,
    CLOCK_REQUIRE_CALIBRATION,
    CLOCK_SAMPLE_COUNT,
    DEFAULTS_ORIGIN,
    DISK_WARNING_BYTES,
    ENDPOINT_BIND_HOST,
    ...
    ENDPOINT_MAX_CONCURRENT_REQUESTS,
    ENDPOINT_MAX_RESPONSE_BYTES,
    ENDPOINT_METRICS_ENABLED,
    ENDPOINT_PORT,
    ENDPOINT_REQUEST_TIMEOUT_SECONDS,
    ENDPOINT_SHUTDOWN_TIMEOUT_SECONDS,
