...
Raised again from 22 to 25 by Phase 025, for the same reason and on the same
evidence: `ta-lib` was adopted, its entry left for the stack contract, and the
lowest phase any remaining entry names is 45. The floor moved because the survey
did, not to satisfy a test.
